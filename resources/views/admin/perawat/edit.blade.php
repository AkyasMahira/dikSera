...
<head>
    <meta charset="utf-8">
    <title>Edit Perawat - DIK SERA (Admin)</title>
...
<div class="page-shell">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <div class="text-muted small mt-1">
                    <i class="bi bi-shield-lock me-1"></i> Mode Admin • Edit Perawat
                </div>
            </div>
        </div>
        <div class="text-end d-none d-md-block">
            <a href="{{ route('admin.perawat.index') }}" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-arrow-left me-1"></i> Kembali ke Daftar Perawat
            </a>
        </div>
    </div>
    ...
    <div class="card-auth">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between gap-3 mb-4">
            <div>
                <div class="section-label">Admin • Data Perawat</div>
                <h4 class="mb-1">Edit Perawat & Daftar Riwayat Hidup</h4>
                <p class="text-muted small mb-0">
                    Update <strong>akun login</strong> dan <strong>DRH lengkap</strong> perawat.
                </p>
            </div>
            <div class="text-md-end text-start">
                <span class="chip-role">Admin Panel</span>
                <div class="text-muted small mt-2">
                    Perawat: <strong>{{ $perawat->name }}</strong><br>
                    Email: <span class="text-muted">{{ $perawat->email }}</span>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.perawat.update', $perawat->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            {{-- I. Identitas & Akun + Foto --}}
            <div class="mb-4">
                <div class="section-title">I. Identitas Diri & Akun Login</div>
                <div class="row g-3">
                    <div class="col-md-8">
                        <div class="row g-3">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                ...
                                @php
                                    $religions = ['Islam','Kristen','Katholik','Hindu','Budha','Konghucu','Lainnya'];
                                    $relValue = old('religion', $profile->religion ?? '');
                                @endphp
                                <select name="religion" class="form-select">
                                    <option value="">Pilih</option>
                                    @foreach($religions as $rel)
                                        <option value="{{ $rel }}" {{ $relValue==$rel?'selected':'' }}>
                                            {{ $rel }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="marital_status" class="form-select">
                                    <option value="">Pilih</option>
                                    <option {{ $ms=='Belum Menikah'?'selected':'' }}>Belum Menikah</option>
                                    <option {{ $ms=='Menikah'?'selected':'' }}>Menikah</option>
                                    <option {{ $ms=='Janda/Duda'?'selected':'' }}>Janda/Duda</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="office_address" rows="2" class="form-control">{{ old('office_address', $profile->office_address ?? '') }}</textarea>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="work_unit"
                                       value="{{ old('work_unit', $profile->work_unit ?? '') }}"
                                       class="form-control">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" id="regPassword"
                                           class="form-control" placeholder="Biarkan kosong jika tidak diubah">
                    ...
                    <div class="col-md-4 mt-3 mt-md-0">
                        ...
                        <div class="d-flex flex-column align-items-center gap-2">
                            <div class="photo-box">
                                @php
                                    $photoUrl = isset($profile->profile_photo) && $profile->profile_photo
                                ...
                                <img id="photoPreview"
                                     src="{{ $photoUrl }}"
                                     alt="Preview Foto"
                                     style="max-width:100%;max-height:100%;{{ $photoUrl ? '' : 'display:none;' }}object-fit:cover;">
                                <span id="photoPlaceholder" class="text-muted small" style="{{ $photoUrl ? 'display:none;' : '' }}">
                                    3x4
                                </span>
                            </div>
                            ...
                            @if($photoUrl)
                                <small class="text-muted small">Foto saat ini sudah tersimpan.</small>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm dynamic-table align-middle" id="familyTable">
                        ...
                        @forelse($families as $f)
                            <tr>
                                <td><input type="text" name="family_name[]" class="form-control form-control-sm"
                                           value="{{ $f->name }}"></td>
                                <td><input type="text" name="family_relationship[]" class="form-control form-control-sm"
                                           value="{{ $f->relationship }}" placeholder="Suami/Istri/Anak"></td>
                                <td><input type="number" name="family_age[]" class="form-control form-control-sm"
                                           value="{{ $f->age }}" min="0"></td>
                                <td><input type="text" name="family_education[]" class="form-control form-control-sm"
                                           value="{{ $f->education }}"></td>
                                <td><input type="text" name="family_occupation[]" class="form-control form-control-sm"
                                           value="{{ $f->occupation }}"></td>
                ...
                <div class="table-responsive">
                    <table class="table table-sm dynamic-table align-middle" id="eduTable">
                        ...
                        @forelse($educations as $e)
                            <tr>
                                <td><input type="text" name="edu_level[]" class="form-control form-control-sm"
                                           value="{{ $e->level }}" placeholder="D3/S1/Profesi"></td>
                                <td><input type="text" name="edu_institution[]" class="form-control form-control-sm"
                                           value="{{ $e->institution }}"></td>
                                <td><input type="text" name="edu_city[]" class="form-control form-control-sm"
                                           value="{{ $e->city }}"></td>
                                <td>
                                    @php
                                        $ys = $e->year_start ? substr($e->year_start,0,4) : '';
                                    @endphp
                                    <input type="text" name="edu_year_start[]" class="form-control form-control-sm"
                                           value="{{ $ys }}" placeholder="2013">
                                </td>
                                <td>
                                    @php
                                        $ye = $e->year_end ? substr($e->year_end,0,4) : '';
                                    @endphp
                                    <input type="text" name="edu_year_end[]" class="form-control form-control-sm"
                                           value="{{ $ye }}" placeholder="2017">
                                </td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-outline-danger btn-icon btn-sm" onclick="removeRow(this)">
                                        &times;
                        ...
                        @empty
                            <tr>
                                ...
                                <td><input type="text" name="edu_year_start[]" class="form-control form-control-sm" placeholder="2013"></td>
                                <td><input type="text" name="edu_year_end[]" class="form-control form-control-sm" placeholder="2017"></td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-outline-danger btn-icon btn-sm" onclick="removeRow(this)">
                                        &times;
                                    </button>
            ...
            <div class="mb-4">
                ...
                <div class="table-responsive">
                    <table class="table table-sm dynamic-table align-middle" id="jobTable">
                        ...
                        @forelse($jobs as $j)
                            <tr>
                                <td><input type="text" name="job_position[]" class="form-control form-control-sm"
                                           value="{{ $j->position }}" placeholder="Perawat Pelaksana"></td>
                                <td><input type="text" name="job_institution[]" class="form-control form-control-sm"
                                           value="{{ $j->institution }}"></td>
                                <td><input type="text" name="job_year_start[]" class="form-control form-control-sm"
                                           value="{{ $j->year_start }}" placeholder="2020"></td>
                                <td><input type="text" name="job_year_end[]" class="form-control form-control-sm"
                                           value="{{ $j->year_end }}" placeholder="2024 / Sekarang"></td>
                                <td><input type="text" name="job_description[]" class="form-control form-control-sm"
                                           value="{{ $j->description }}"></td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-outline-danger btn-icon btn-sm" onclick="removeRow(this)">
                                        &times;
                                    </button>
            ...
            @php
                $wajib = $certificates->where('type','wajib');
                $dev   = $certificates->where('type','pengembangan');
            @endphp
            ...
            <div class="mb-4">
                ...
                <p class="text-muted small mb-2">
                    STR, BTCLS, PPGD, dll. Jika <strong>Tanggal Habis</strong> kosong → dianggap <strong>lifetime</strong>.
                </p>
                <div class="table-responsive">
                    <table class="table table-sm dynamic-table align-middle" id="certWajibTable">
                        ...
                        @forelse($wajib as $c)
                            <tr>
                                <td><input type="text" name="cert_wajib_name[]" class="form-control form-control-sm"
                                           value="{{ $c->name }}"></td>
                                <td><input type="text" name="cert_wajib_desc[]" class="form-control form-control-sm"
                                           value="{{ $c->description }}"></td>
                                <td>
                                    <input type="date" name="cert_wajib_start[]" class="form-control form-control-sm"
                                           value="{{ $c->date_start ? $c->date_start->format('Y-m-d') : '' }}">
                                </td>
                                <td>
                                    <input type="date" name="cert_wajib_end[]" class="form-control form-control-sm"
                                           value="{{ $c->date_end ? $c->date_end->format('Y-m-d') : '' }}">
                                </td>
                                <td>
                                    <input type="file" name="cert_wajib_file[]" class="form-control form-control-sm" accept=".pdf,image/*">
                                    @if($c->file_path)
                                        <small class="text-muted d-block mt-1">
                                            <span class="badge bg-light text-dark badge-file">
                                                <i class="bi bi-file-earmark-text me-1"></i>File tersimpan
                                            </span>
                                        </small>
                                    @endif
                                </td>
            ...
            <div class="mb-4">
                ...
                <p class="text-muted small mb-2">
                    Pelatihan, workshop, seminar, dan pengembangan kompetensi lainnya.
                </p>
                <div class="table-responsive">
                    <table class="table table-sm dynamic-table align-middle" id="certDevTable">
                        ...
                        @forelse($dev as $c)
                            <tr>
                                <td><input type="text" name="cert_dev_name[]" class="form-control form-control-sm"
                                           value="{{ $c->name }}"></td>
                                <td><input type="text" name="cert_dev_desc[]" class="form-control form-control-sm"
                                           value="{{ $c->description }}"></td>
                                <td>
                                    <input type="date" name="cert_dev_start[]" class="form-control form-control-sm"
                                           value="{{ $c->date_start ? $c->date_start->format('Y-m-d') : '' }}">
                                </td>
                                <td>
                                    <input type="date" name="cert_dev_end[]" class="form-control form-control-sm"
                                           value="{{ $c->date_end ? $c->date_end->format('Y-m-d') : '' }}">
                                </td>
                                <td>
                                    <input type="file" name="cert_dev_file[]" class="form-control form-control-sm" accept=".pdf,image/*">
                                    @if($c->file_path)
                                        <small class="text-muted d-block mt-1">
                                            <span class="badge bg-light text-dark badge-file">
                                                <i class="bi bi-file-earmark-text me-1"></i>File tersimpan
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 mt-4">
                <p class="text-muted small mb-0">
                    Admin akan menyimpan perubahan DRH perawat.
                </p>
        ...
        <div class="text-center mt-3 d-md-none">
            <small class="text-muted">
                <a href="{{ route('admin.perawat.index') }}">Kembali ke daftar perawat</a>
            </small>
        </div>
    </div>
</div>
