{{-- resources/views/admin/perawat/create.blade.php --}}
<!doctype html>
<html lang="id">
<head>
    <meta charset="utf-8">
    <title>Tambah Perawat - DIK SERA (Admin)</title>
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <div class="text-muted small mt-1">
                    <i class="bi bi-shield-lock me-1"></i> Mode Admin • Tambah Perawat
                </div>
            </div>
        </div>
    ...
    <div class="card-auth">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between gap-3 mb-4">
            <div>
                ...
                <h4 class="mb-1">Tambah Perawat + Daftar Riwayat Hidup</h4>
                <p class="text-muted small mb-0">
                    Admin dapat menginput <strong>akun login</strong> dan <strong>DRH lengkap</strong> perawat.
                </p>
            </div>
        ...
        <form action="{{ route('admin.perawat.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 mt-4">
                <p class="text-muted small mb-0">
                    Admin akan membuat akun perawat & menyimpan DRH lengkap.
                </p>
                <button class="btn btn-primary-soft px-4">
                    <i class="bi bi-person-plus me-1"></i> Simpan Perawat & DRH
                </button>
            </div>
        </form>
